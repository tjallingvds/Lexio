import { S as SlateEditor, a as SlatePlugin, P as PluginConfig, A as AnyPluginConfig, b as SlatePluginMethods, W as WithRequiredKey, c as SlatePluginContext, I as InferConfig, R as RenderElementProps, d as AnyEditorPlugin, N as NodeComponents, e as RenderLeafProps, E as EditableProps, f as AnySlatePlugin, B as BoxStaticProps, g as SlateRenderElementProps, h as SlateRenderLeafProps, T as TextStaticProps, i as SlateRenderNodeProps, j as ExtendEditor, O as OverrideEditor, H as HtmlDeserializer, L as LengthConfig, k as EditorPlugin, l as ParserOptions, m as SlatePlugins } from './withSlate-qYKZgnjZ.mjs';
export { t as BaseDeserializer, n as BaseEditor, u as BaseHtmlDeserializer, v as BaseInjectProps, x as BasePlugin, y as BasePluginContext, z as BasePluginNode, D as BaseSerializer, F as BaseTransformOptions, q as BaseWithSlateOptions, ag as CorePlugin, C as CreateSlateEditorOptions, aj as DebugConfig, ak as DebugErrorType, an as DebugPlugin, _ as Decorate, $ as Deserializer, G as ExtendConfig, a0 as ExtendEditorApi, a1 as ExtendEditorTransforms, ah as GetCorePluginsOptions, J as GetInjectNodePropsOptions, K as GetInjectNodePropsReturnType, Z as HandlerReturnType, a2 as HtmlSerializer, M as InferApi, Q as InferOptions, o as InferPlugins, U as InferSelectors, V as InferTransforms, a3 as InjectNodeProps, al as LogLevel, X as NodeComponent, a4 as NodeStaticProps, a5 as NodeStaticWrapperComponent, a6 as NodeStaticWrapperComponentProps, a7 as NodeStaticWrapperComponentReturnType, a8 as NormalizeInitialValue, a9 as Parser, am as PlateError, ao as RenderElementFn, ap as RenderLeafFn, aa as RenderStaticNodeWrapper, ab as RenderStaticNodeWrapperFunction, ac as RenderStaticNodeWrapperProps, ad as Serializer, ae as SlatePluginConfig, p as TSlateEditor, af as TransformOptions, Y as WithAnyKey, r as WithSlateOptions, s as createSlateEditor, ai as getCorePlugins, w as withSlate } from './withSlate-qYKZgnjZ.mjs';
export { nanoid } from 'nanoid';
export { TStateApi as ZustandStoreApi, createZustandStore } from 'zustand-x';
import { Modify, AnyObject, Nullable } from '@udecode/utils';
...
declare function BaseLeafStatic({ components, decorations, editor, leaf, }: {
    components: NodeComponents;
    decorations: DecoratedRange[];
    editor: SlateEditor;
    leaf: TText;
...
declare const getPluginNodeProps: ({ attributes, node, plugin, props, }: {
    props: SlateRenderNodeProps;
    attributes?: AnyObject;
    node?: TElement | TText;
    plugin?: AnyEditorPlugin;
...
export { AnyEditorPlugin, AnyPluginConfig, AnySlatePlugin, type ApplyDeepToNodesOptions, AstPlugin, BaseParagraphPlugin, BoxStaticProps, CARRIAGE_RETURN, type CollapseWhiteSpaceState, DOMPlugin, type DeserializeHtmlChildren, type DeserializeHtmlNodeReturnType, EditableProps, EditorPlugin, ElementStatic, ExtendEditor, HistoryPlugin, Hotkeys, HtmlDeserializer, HtmlPlugin, InferConfig, InlineVoidPlugin, LINE_FEED, LeafStatic, LengthConfig, LengthPlugin, NO_BREAK_SPACE, NodeComponents, OverrideEditor, type ParagraphConfig, ParserOptions, ParserPlugin, PlateStatic, type PlateStaticProps, PluginConfig, RenderElementProps, RenderLeafProps, SPACE, type SerializeHtmlOptions, SlateEditor, SlateElement, type SlateElementProps, SlateExtensionPlugin, SlateLeaf, type SlateLeafProps, SlatePlugin, SlatePluginContext, SlatePluginMethods, SlatePlugins, type SlateRenderElement, SlateRenderElementProps, type SlateRenderLeaf, SlateRenderLeafProps, SlateRenderNodeProps, TAB, TextStaticProps, type TrimEndRule, type TrimStartRule, type WhiteSpaceRule, WithRequiredKey, ZERO_WIDTH_SPACE, applyDeepToNodes, applyPluginsToEditor, cleanHtmlBrElements, cleanHtmlCrLf, cleanHtmlEmptyElements, cleanHtmlFontElements, cleanHtmlLinkElements, cleanHtmlTextNodes, collapseString, collapseWhiteSpace, collapseWhiteSpaceChildren, collapseWhiteSpaceElement, collapseWhiteSpaceNode, collapseWhiteSpaceText, copyBlockMarksToSpanChild, createHotkey, createSlatePlugin, createStaticString, createTSlatePlugin, defaultsDeepToNodes, deserializeHtml, deserializeHtmlElement, deserializeHtmlNode, deserializeHtmlNodeChildren, endInlineFormattingContext, findHtmlElement, getDataNodeProps, getEditorDOMFromHtmlString, getEditorPlugin, getHtmlComments, getInjectMatch, getInjectedPlugins, getKeyByType, getKeysByTypes, getLeafDataAttributes, getNodeDataAttributeKeys, getNodeDataAttributes, getPluginDataAttributes, getPluginNodeProps, getPluginType, getPluginTypes, getRenderNodeStaticProps, getSlateClass, getSlateElements, getSlatePlugin, htmlBodyToFragment, htmlBrToNewLine, htmlElementToElement, htmlElementToLeaf, htmlStringToDOMNode, htmlTextNodeToString, inferWhiteSpaceRule, inlineTagNames, isHtmlBlockElement, isHtmlComment, isHtmlElement, isHtmlFragmentHref, isHtmlInlineElement, isHtmlTable, isHtmlText, isLastNonEmptyTextOfInlineFormattingContext, isOlSymbol, isSlateEditor, isSlateElement, isSlateLeaf, isSlateNode, isSlatePluginElement, isSlatePluginNode, isSlateString, isSlateText, isSlateVoid, isType, keyToDataAttribute, mergeDeepToNodes, normalizeDescendantsToDocumentFragment, omitPluginContext, overridePluginsByKey, parseHtmlDocument, parseHtmlElement, pipeDecorate, pipeDeserializeHtmlElement, pipeDeserializeHtmlLeaf, pipeInsertDataQuery, pipeRenderElementStatic, pipeRenderLeafStatic, pluginDeserializeHtml, pluginRenderElementStatic, pluginRenderLeafStatic, postCleanHtml, preCleanHtml, removeHtmlNodesBetweenComments, removeHtmlSurroundings, replaceTagName, resolveAndSortPlugins, resolvePluginOverrides, resolvePlugins, serializeHtml, someHtmlElement, stripHtmlClassNames, stripSlateDataAttributes, traverseHtmlComments, traverseHtmlElements, traverseHtmlNode, traverseHtmlTexts, unwrapHtmlElement, upsertInlineFormattingContext, withInlineVoid, withPlateHistory };
