...
__export(react_exports, {
  YjsAboveEditable: () => YjsAboveEditable,
  YjsPlugin: () => YjsPlugin
});
module.exports = __toCommonJS(react_exports);

// src/react/YjsAboveEditable.tsx
...
// src/react/YjsAboveEditable.tsx
var YjsAboveEditable = ({ children }) => {
  const { editor } = (0, import_react2.useEditorPlugin)(BaseYjsPlugin);
  const provider = (0, import_react2.usePluginOption)(BaseYjsPlugin, "provider");
  const isSynced = (0, import_react2.usePluginOption)(BaseYjsPlugin, "isSynced");
  import_react.default.useEffect(() => {
    void provider.connect();
    return () => provider.disconnect();
  }, [provider]);
  import_react.default.useEffect(() => {
    import_core4.YjsEditor.connect(editor);
    return () => import_core4.YjsEditor.disconnect(editor);
...
var YjsPlugin = (0, import_react3.toPlatePlugin)(BaseYjsPlugin, {
  render: {
