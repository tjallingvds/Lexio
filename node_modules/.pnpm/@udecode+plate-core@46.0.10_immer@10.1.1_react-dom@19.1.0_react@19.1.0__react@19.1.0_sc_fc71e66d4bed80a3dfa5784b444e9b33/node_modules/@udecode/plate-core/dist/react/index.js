...
__export(react_exports, {
  ...
  DefaultElement: () => import_slate_react.DefaultElement,
  ...
  useStoreSelect: () => import_zustand_x3.useStoreSelect,
  useStoreSetAtom: () => import_jotai_x.useStoreSetAtom,
  useStoreState: () => import_zustand_x3.useStoreState,
  useStoreValue: () => import_zustand_x3.useStoreValue,
  useTracked: () => import_zustand_x3.useTracked,
  useTrackedStore: () => import_zustand_x3.useTrackedStore,
...
var pluginInjectNodeProps = (editor, plugin, nodeProps, getElementPath) => {
  ...
  if (!transformProps && (!(0, import_utils2.isDefined)(nodeValue) || validNodeValues && !validNodeValues.includes(nodeValue) || nodeValue === defaultNodeValue)) {
    return;
  }
  ...
  editor.pluginList.forEach((plugin) => {
    if (plugin.inject.nodeProps) {
      ...
      nodeProps = {
        ...nodeProps,
        ...newProps,
        className: (0, import_clsx.default)(nodeProps.className, newProps.className),
        style: {
          ...nodeProps.style,
          ...newProps.style
        }
...
var getPluginNodeProps = ({
  ...
  if (!newProps.nodeProps && attributes && plugin) {
    newProps.nodeProps = (0, import_pick.default)(attributes, [
    ...
    newProps.nodeProps = {
      ...newProps.nodeProps,
      ...(0, import_pick.default)(attributes, [...node ? getNodeDataAttributeKeys(node) : []])
    };
  }
        ...
        if (validAttribute) {
          if (typeof validAttribute === "string") {
            ...
            for (const [attributeName, attributeValue] of Object.entries(
              ...
              if (!(0, import_utils3.isDefined)(elAttribute) || !attributeValues.includes(elAttribute))
                return false;
            }
          }
        }
...
var HtmlPlugin = createSlatePlugin({
  ...
  deserialize: (0, import_utils5.bindFirst)(deserializeHtml, editor)
})).extend({
  parser: {
    format: "text/html",
...
function DefaultLeaf(props) {
  ...
  return /* @__PURE__ */ import_react.default.createElement("span", { ...rootProps });
}
...
var SlateReactExtensionPlugin = toPlatePlugin(SlateExtensionPlugin, {
  ...
  transforms: {
    normalizeNode(entry, options) {
      if ((0, import_utils8.isDefined)(entry[0]._memo)) {
...
var EventEditorStore = (0, import_zustand_x2.createZustandStore)(
  {
    blur: null,
    focus: null,
    last: null
...
var getRenderNodeProps = ({
  ...
  nodeProps = {
    ...
    className: (0, import_clsx3.clsx)(getSlateClass(plugin?.node.type), className)
  };
...
var pipeRenderLeaf = (editor, renderLeafProp) => {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react4.default.createElement(DefaultLeaf, { ...ctxProps });
  };
};
...
var useEditableProps = ({
  ...
  const renderLeaf = import_react5.default.useMemo(() => {
...
var useNodePath = (node) => {
  ...
  return (0, import_react_utils.useMemoizedSelector)(
    () => {
...
var useSlateProps = ({
  ...
  const onValueChange = import_react6.default.useMemo(
    () => (value) => {
      updateVersionValue();
  ...
  const onSelectionChange = import_react6.default.useMemo(
    () => (selection) => {
...
function ElementContent({
  ...
  const Element = plugin.render?.node ?? import_slate_react.DefaultElement;
  ...
  let component = /* @__PURE__ */ import_react7.default.createElement(Element, { ...nodeProps }, children);
...
var pipeRenderElement = (editor, renderElementProp) => {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react8.default.createElement(import_slate_react.DefaultElement, { attributes: props.attributes, element: props.element }, props.children);
  };
};
...
var usePlateControllerStore = (idProp) => {
  const storeAtom = import_react9.default.useMemo(
...
var usePlateStore = (id) => {
  ...
  const [localStoreExists] = import_react10.default.useState(!!localStore.store);
  ...
  const fallbackStore = (0, import_react10.useMemo)(createPlateStore, []).usePlateStore();
  if (!store) {
...
var import_utils11 = require("jotai/utils");
var useElementSelector = (selector, deps, {
  key,
  equalityFn = (a, b) => a === b
} = {}) => {
  const selectorAtom = import_react13.default.useMemo(
    () => (0, import_utils11.selectAtom)(
...
function EditorHotkeysEffect({
  ...
  const editor = useEditorRef(id);
  return /* @__PURE__ */ import_react14.default.createElement(import_react14.default.Fragment, null, Object.entries(editor.shortcuts).map(([hotkeyString, hotkeyConfig]) => {
    if (!hotkeyConfig || !(0, import_utils12.isDefined)(hotkeyConfig.keys) || !hotkeyConfig.handler) {
      return null;
    }
...
function EditorRefEffect({ id }) {
  ...
  return /* @__PURE__ */ import_react16.default.createElement(import_react16.default.Fragment, null, editor.pluginList.map((plugin) => /* @__PURE__ */ import_react16.default.createElement(EditorRefPluginEffect, { id, key: plugin.key, plugin })));
}

// src/react/components/EditorStateEffect.tsx
var import_react17 = __toESM(require("react"));
var EditorStateEffect = import_react17.default.memo(() => {
  return null;
});
...
function Plate(props) {
  ...
  const scrollRef = import_react19.default.useRef(null);
...
var PlateControllerEffect = ({
  ...
  const currentStoreAtom = import_react20.default.useMemo(
  ...
  const setCurrentStore = (0, import_react_utils2.useStableFn)(
    usePlateControllerLocalStore().setAtom(currentStoreAtom),
    [currentStoreAtom]
  );
  const setPrimaryEditorIds = (0, import_react_utils2.useStableFn)(
    (0, import_jotai_x10.useAtomStoreSet)(usePlateControllerLocalStore(), "primaryEditorIds")
  );
  const setActiveId = (0, import_react_utils2.useStableFn)(
...
function PlateSlate({
  ...
  const editor = useEditorRef(id);
  let aboveSlate = /* @__PURE__ */ import_react21.default.createElement(import_slate_react.Slate, { ...slateProps }, children);
  editor.pluginList?.forEach((plugin) => {
    const {
      render: { aboveSlate: AboveSlate }
    } = plugin;
    if (AboveSlate) aboveSlate = /* @__PURE__ */ import_react21.default.createElement(AboveSlate, null, aboveSlate);
  });
  return aboveSlate;
}

// src/react/components/PlateContent.tsx
var PlateContent = import_react22.default.forwardRef(
  ({ autoFocusOnEditable, renderEditable, ...props }, ref) => {
    ...
    const editableRef = (0, import_react22.useRef)(null);
    const combinedRef = (0, import_react_utils3.useComposedRef)(ref, editableRef);
    const editable = /* @__PURE__ */ import_react22.default.createElement(import_slate_react.Editable, { ref: combinedRef, ...editableProps });
    ...
    editor.pluginList.forEach((plugin) => {
      ...
      if (AfterEditable) {
        afterEditable = /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, afterEditable, /* @__PURE__ */ import_react22.default.createElement(AfterEditable, { ...editableProps }));
      }
      if (BeforeEditable) {
        beforeEditable = /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, beforeEditable, /* @__PURE__ */ import_react22.default.createElement(BeforeEditable, { ...editableProps }));
      }
    });
    let aboveEditable = /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, renderEditable ? renderEditable(editable) : editable, /* @__PURE__ */ import_react22.default.createElement(EditorMethodsEffect, { id }), /* @__PURE__ */ import_react22.default.createElement(EditorHotkeysEffect, { id, editableRef }), /* @__PURE__ */ import_react22.default.createElement(EditorRefEffect, { id }), /* @__PURE__ */ import_react22.default.createElement(PlateControllerEffect, { id }));
    editor.pluginList.forEach((plugin) => {
      const {
        render: { aboveEditable: AboveEditable }
      } = plugin;
      if (AboveEditable)
        aboveEditable = /* @__PURE__ */ import_react22.default.createElement(AboveEditable, null, aboveEditable);
    });
    const readOnly = props.readOnly ?? false;
    const prevReadOnly = import_react22.default.useRef(readOnly);
    ...
    return /* @__PURE__ */ import_react22.default.createElement(PlateSlate, { id }, beforeEditable, aboveEditable, afterEditable);
  }
);
...
function PlateTest({
  ...
  return /* @__PURE__ */ import_react24.default.createElement(Plate, { ...props, editor }, /* @__PURE__ */ import_react24.default.createElement(
    PlateContent,
    {
...
var withHOC = (HOC, Component, hocProps, hocRef) => import_react25.default.forwardRef((props, componentRef) => /* @__PURE__ */ import_react25.default.createElement(HOC, { ...hocProps, ref: hocRef }, /* @__PURE__ */ import_react25.default.createElement(Component, { ...props, ref: componentRef })));
